...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(prompt_char dir vcs command_execution_time)
  # Right prompt segments.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(todo public_ip vpn_ip)
  ...
  # typeset -g POWERLEVEL9K_PROMPT_CHAR_CONTENT_EXPANSION='契'
  # typeset -g POWERLEVEL9K_PROMPT_CHAR_CONTENT_EXPANSION='[%T%B %n]➜'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_CONTENT_EXPANSION='%{$fg[yellow]%}[%D{%f/%m/%y} %D{%L:%M:%S}] %B➜ '
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='$P9K_IP_IP${P9K_IP_RX_RATE:+ %76F⇣$P9K_IP_RX_RATE}${P9K_IP_TX_RATE:+ %3F⇡$P9K_IP_TX_RATE}'
