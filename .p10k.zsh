# Generated by Powerlevel10k configuration wizard on 2022-02-26 at 00:00 IST.
...
# 24h time, 1 line, sparse, few icons, concise, instant_prompt=auto-quiet.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.(%153F)(%196F)(%123F)(%176F)(%225F)()()(219)(159) (142)
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=
  # Custom icon.(ﳛ)()(|)(פֿ)      (%196F)(%176F)(%219F)
  # typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='⭐'
  # typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='%6F %149F%n'
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='%142F%n'
  # typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='%220F %219F%n'
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='%51F%B➜ '
  ...
  # elly-theme(https://github.com/ulwlu/elly-iterm2)
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%9F'    # elly theme
      # local   modified='%3F'  # yellow foreground
      local   modified='%58F'   # elly theme
      # local  untracked='%4F'  # blue foreground
      local  untracked='%6F'    # elly theme
      # local conflicted='%1F'  # red foreground
      local conflicted='%88F'   # elly theme
    else
  ...
  typeset -g POWERLEVEL9K_STATUS_OK=false    # default is value is false
